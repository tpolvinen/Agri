...
Suurin osa mainituista ratkaisuista on pilvipalveluita, joita käytetään maatilanhallintajärjestelminä, maatilan tuottaman datan integrointiin, yhteishankinta-alustoina, viljelijöiden verkostoitumiseen jne. Haastattelumateriaalissa ei mainittu N-sensorin ja SoilScoutin lisäksi nimeltä muita tuotteita, joita käytettäisi viljely-ympäristön tai kasvien mittarointiin. Toisaalta vastaaviin ratkaisuihin liittyviä teknologioita, järjestelmiä ja palveluita kuten sensoritekniikkaa käsiteltiin yleisesti.  
