...
Aineiston pelkistämisen analyysimallissa edetään tunnistamalla asiat, joista tutkimuksessa ollaan kiinnostuneita ja pelkistetään näitä asioita ilmaisevia lauseita yksittäisiksi ilmaisuiksi. Seuraavaksi samaa kuvaavat ilmaisut luokitellaan samaan alaluokkaan ja luokka nimetään sen sisältöä kuvaavasti. Tutkijan tulkinnasta riippuu, millä perusteella ilmaisut kuuluvat samaan luokkaan. Analyysiä jatketaan luokittelemalla samansisältöisiä alaluokkia yläluokkiin, jotka nimetään sisältöä kuvaavasti samoin kuin alaluokat. Aineistosta riippuen voidaan yläluokkia vielä luokitella pääluokkiin. Lopulta kaikki luokat yhdistetään niitä kuvaavaan luokkaan ja luokkien avulla vastataan tutkimustehtävään. Analyysimallin avulla pyritään tulkintaprosessin systematisointiin sekä tulkinnan mielivaltaisuuden välttämiseen. (@tuomiLaadullinenTutkimusJa2018, 114-116)

*4.4.2 yleisesti: Analyysissä tuotettu aineisto voidaan kvantifioida (Silverman, Inrerpeting q data 2006)*

*4.4.3 aineistolähtöinen analyysi etenee vaiheittain: määritä analyysiyksikkö, aineiston laatu ja tutkimustehtävä ohjaavat, pelkistämisessä data voi olla monenlaista kirjoitettua.*
*1. vaihe on pelkistäminen (redusointi) ilmauksiin, sitten ryhmittely (klusterointi) alaluokkiin, käsitteellistämisessä datan ilmauksista teoreettisiin käsitteisiin pääluokkiin(abstrahointi)*
*"aineistolähtöisessä sisällönanalyysissä yhdistetään käsitteitä ja näin saadaan vastaus tutkimustehtävään"*

*aineistolähtöisyyden takia ei voi etukäteen määrittää millaisia luokkia voidaan muodostaa, vaan selviää vasta analyysin edetessä*

*4.4.5 teoriaohjaava sisällönanalyysi: lähtökohdiltaan samoin kuin aineistolähtöinen sisällönanalyysi, mutta abstrahoinssa empiirinen aineisto liitetään teoreettisiin käsitteisiin. Aineistosta luodut vs. jo tiedetyt*
...
*4.4.7 aineiston kvantifionti: sisällönanalyysiä voidaan jatkaa luokittelun jälkeen kvantifiomalla aineisto. (...lasketaan kuinka monta kertaa sama asia esiintyy...tai kuinka moni tutkittava ilmaisee saman asian...)*

*sisällönanalyysin ja sisällön erittelyn (kvantifionnin) sisällyttäminen samaan tutkimukseen liittää tällaisen tutkimuksen periaatteessa MMR-lähestymistapaan (mixed methods research) metoditasolla.*

*"Esimerkiksi aineiston teemoittaminen (Kuvio 14, s. 106) ennen varsinaisen analyysin aloittamista saattaa joskus olla sisällönanalyysia selkeyttävä tai ainakin helpottava. Toisaalta temaattisen analyysin kuvaaminen systemaattisena taulukkona kuten sisällönanalyysissa (tämän kirjan mukaan) saattaa antaa lukijalle selkeämmän kuvan analyysin etenemisestä, tai se ainakin säästää tilaa raportissa suhteessa useampaan käsitekarttaan ja niiden tiivistämiseen."*

*"Ehkä keskeisintä ei kuitenkaan ole se, millä nimellä analyysia kutsutaan, vaan se, että se on tehty systemaattisesti, että lukija ymmärtää, mitä on tehty ja että tulokset ovat perusteltuja."*
...
Tutkittaessa eri metodeita haastattelumateriaalin havainnollistamiseen ja tiivistämiseen tutustuttiin pintapuolisesti ensin affiniteettianalyysiin, sisällönanalyysiin, Grounded theory:n (ankkuroitu teoria), sisällön teemoitteluun ja taulukointiin. 
