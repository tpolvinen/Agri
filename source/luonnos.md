...
Monikerrosviljelyllä tarkoitetaan useissa päällekkäisissä tasoissa tapahtuvaa viljelyä, mikä eroaa tavallisen kasvihuoneen yhdessä tasossa tapahtuvasta viljelystä.
...
Haastatteluissa A.A. kuvaili maatalouden yleistä tilannetta AIoT:n näkökulmasta hyvin hajanaiseksi ja pirstaleiseksi. C.C.:n mielestä yleistilanne on samaan tapaan hyvin sekava ja B.B. kuvaili erityisesti peltokasvituotannon tavoitetilan olevan useiden teknisten rajoitteiden takana. D.D.:n mukaan on kehitetty useita **ratkaisuita** mutta näiden järjestelmien välinen vapaa ja avoin yhteistyö ja dataintegraatio on vielä vaikeaa. E.E. puolestaan näkee, että AIoT:n teknologiaratkaisuissa ja maatalouden digitalisaatiossa ollaan murroksen partaalla. (@aHaastattelu2017, @bHaastattelu2017, @cHaastattelu2017, @dHaastattelu2018, @eHaastattelu2018)
